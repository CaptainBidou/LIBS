...
mycursor.execute("CREATE TABLE measures_soh (id INT AUTO_INCREMENT PRIMARY KEY, id_test INT, id_cell INT, voc FLOAT, r0 FLOAT, soc FLOAT, time TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (id_test) REFERENCES tests(id), FOREIGN KEY (id_cell) REFERENCES cells(id))")
