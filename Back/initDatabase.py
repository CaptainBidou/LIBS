...
mycursor.execute("CREATE TABLE actions (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), brief VARCHAR(255), function VARCHAR(255), chargeBool BOOLEAN, dischargeBool BOOLEAN, crate_bool BOOLEAN)")
...
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Constant Current-Constant Voltage', 'CCCV', 'CCCV', 1, 0, 1)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Constant discharge', 'CDch', 'Constant', 0, 1, 1)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Dynamic stress test', 'DST', 'DST', 1, 1, 0)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Hybrid pulse power characterization', 'HPPC', 'HPPC', 1, 1, 0)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Pulse discharge', 'PDch', 'Pulse', 0, 1, 1)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Random pulse discharge', 'RPDch', 'Random', 0, 1, 0)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Random stress discharge', 'RSDch', 'RDST', 0, 1, 0)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Multi pulse discharge', 'MPDch', 'MPD', 0, 1, 0)")
mycursor.execute("INSERT INTO actions (name, brief, function, chargeBool, crate_bool) VALUES ('Dynamic pulse discharge', 'DPDch', 'DPD', 0, 1, 0)")
