...
def put(measure_soh):
    return phpMyAdmin.request("INSERT INTO `measures_soh` (`id_cell`,`id_test`,`time`,`voc`,`r0`,`soc`) VALUES (%s, %s, %s, %s, %s, %s)", (measure_soh.cell.id,measure_soh.test.id,measure_soh.time,measure_soh.voc,measure_soh.r0,measure_soh.soc))